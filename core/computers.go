...
// IsValidMECTRole returns true if the input string represents a valid MECT role
func IsValidMECTRole(role string) bool {
	switch role {
	case MECTRoleNFTCreate, MECTRoleNFTAddQuantity, MECTRoleNFTBurn, MECTRoleLocalMint, MECTRoleLocalBurn, MECTRoleNFTUpdateAttributes,
		MECTRoleNFTAddURI, MECTRoleTransfer:
		return true
	default:
		return false
	}

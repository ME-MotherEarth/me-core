//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/ME-MotherEarth/protobuf/protobuf  --gogoslick_out=. trigger.proto
package block

import "github.com/ME-MotherEarth/me-core/data"
